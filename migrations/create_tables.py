...
async def main():
    ...
    try:
        ...
        async with connection:  #check and open connection if not opened
            async with connection.transaction():  # opening a transaction
                async with connection.cursor() as cursor:  #getting a cursor
                    await cursor.execute(  #executing a request
                        query="""
